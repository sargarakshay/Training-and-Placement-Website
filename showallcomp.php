					...
					<h3>All companies</h3><br/>					
							<?php
								...
								if(!$result ){
									...
									if($num_rows == 0){
										echo "No companies right now";
									}
									else{
										echo '<table class="table">';
										echo '<tr><td><h4>Company Name</h4></td><td><h4>Primary Field</h4></td><td><h4>Remove company</h4></td></tr>';
										while($row = mysqli_fetch_array($result)){
											$Name = $row['Name'];
											$Brach = $row['Field1'];
											echo '<tr><td>'.$Name.'</td><td>'.$Brach.'</td><td>';
											echo '<a href = "deletec.php?Name='.$Name.'"><span style="color:#42f495">Remove company</span></a>';
											echo '</td></tr>';
										}
									}
								}
