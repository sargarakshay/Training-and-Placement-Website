								...
								<?php
									...
									if(! $result ){
										...
										if($num_rows==0){
											...
											echo "No companies present right now";
											echo '</span>';
										}
										else{
											echo '<tr class = "success"><th>Comapny name</th><th>Branch</th><th>Criteria</th></tr>';
											while($row = mysqli_fetch_array($result)) {
												$Name = $row['Name'];
												$Branch = $row['Field1'];
												$Criteria = $row['Cpi'];
												echo '<tr class = "active"><td>'.$Name.'</td><td>'.$Branch.'</td><td>'.$Criteria.'</td></tr>';
											}
										}
									}
								?>
